...
!-----------------------------------------------------------------------------------------------------------------------------------
! ident_1="@(#)d2j(3f): Converts proleptic Gregorian date array to Julian Day"
...
! ident_2="@(#)j2d(3f): Converts Julian Day to date array"
...
! ident_3="@(#)d2u(3f): Converts date array to Unix Time (UT starts at 0000 on 1 Jan. 1970)"
...
! REF:JSU:2015-12-12
!-----------------------------------------------------------------------------------------------------------------------------------
! ident_4="@(#)u2d(3f): Converts Unix Time to date array"
...
! ident_5="@(#)d2o(3f): Converts date-time array to Ordinal day"
INTEGER,INTENT(IN)         :: dat(8)                  ! date time array similar to that returned by DATE_AND_TIME
...
! ident_6="@(#)v2mo(3f): returns the month name of a Common month"
...
!===================================================================================================================================
FUNCTION now(format)
! ident_7="@(#)now(3f): return string representing current time given format JSU 2015-10-24"
...
!-----------------------------------------------------------------------------------------------------------------------------------
! ident_8="@(#)fmtdate(3f): given date array return date as string using format"
...
! ident_9="@(#)fmtdate_usage(3f): display macros recognized by fmtdate(3f) JSU 2015-10-24"
...
! ident_10="@(#)dow(3f): Return the day of the week"
...
!-----------------------------------------------------------------------------------------------------------------------------------
! ident_11="@(#)woy(3f): Calculate iso-8601 Week-numbering year date yyyy-Www-d"
...
! ident_12="@(#)dj(3f): Given date array returns Julian Day"
real(kind=dp)              :: julian
...
! ident_13="@(#)jd(3f): Given Julian Day returns date array"
...
! ident_14="@(#)du(3f): Given date array returns Unix Epoch time"
real(kind=dp)              :: unixtime
integer,intent(in)         :: dat(8)
   integer                 :: ierr
...
! ident_15="@(#)ud(3f): Given Unix Epoch Time returns date array"
...
! ident_16="@(#)sys_sleep(3f): call sleep(3c)"
...
! ident_17="@(#)M_time::now_ex(3f): use of now(3f) outside of a module"
...
! ident_18="@(#)M_journal::journal(3fg): provides public message routine, no paging or graphic mode change"
...
! ident_19="@(#)M_journal::where_write_message(3fp): basic message routine used for journal files"
...
! ident_20="@(#)M_journal::flush_trail(3fp): flush trail file"
...
! ident_21="@(#)M_journal::set_stdout_lun(3fp): change I/O logical unit value for standard writes"
...
! ident_22="@(#)M_journal::where_write_message_all(3f): writes a message to a string composed of any standard scalar types"
...
! ident_23="@(#)M_journal::write_message_only(3fp): calls JOURNAL('sc',message)"
...
! ident_24="@(#)M_time::now_ex(3f): use of now(3f) outside of a module"
