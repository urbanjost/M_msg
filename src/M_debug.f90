...
!!
!!##DESCRIPTION
!!    The M_debug(3fm) Fortran module provides procedures and variables
...
! ident_1="@(#)M_debug::unit_check_msg(3f): writes a message to a string composed of any standard scalar types"
...
! ident_2="@(#)M_debug::stderr(3f): writes a message to standard error using a standard f2003 method"
...
! ident_3="@(#)M_debug::fstop(3f): calls 'STOP VALUE' passing in a value (1-32), with optional message"
...
! ident_4="@(#)M_debug::unit_check(3f):if .not.expression call 'goodbad NAME bad' & stop program"
...
! ident_5="@(#)M_debug::unit_check_start(3f): call 'goodbad NAME start'"
...
! ident_6="@(#)M_debug::unit_check_done(3f): call 'goodbad NAME bad'"
...
! ident_7="@(#)M_debug::unit_check_bad(3f): call 'goodbad NAME bad'"
...
! ident_8="@(#)M_debug::unit_check_good(3f): call 'goodbad NAME good'"
...
! ident_9="@(#)M_debug::pdec(3f): write ASCII Decimal Equivalent (ADE) numbers vertically beneath string"
...
! ident_10="@(#)M_debug::atleast(3fp): return string padded to at least specified length"
...
!>
!!##NAME
!!    assert(3f) - [M_debug] print filename, linenumber, and message to stderr and stop program
!!    (LICENSE:PD)
!!##SYNOPSIS
!!
...
! ident_11="@(#)M_debug::assert(3f): writes a message to a string composed of any standard scalar types"
...
! ident_12="@(#)M_time::julian(3f): Converts proleptic Gregorian DAT date-time array to Julian Date"
